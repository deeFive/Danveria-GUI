//Dan Welsh 2011
//Danveria Racing GUI script ver 0.01
...
function OnGUI ()
{
    ...
    GUI.Box (new Rect (0,0, Screen.width, (screenHeight / 5)), "Danveria Ver 0.02 - Racing\nHere we will take a look at the process of creating Racing games for danveria. ");
    ...
    //Current page)
    if(GUI.Button (Rect (135, 95, 175, 25), "Racing"))
    {
    ...
    HardwareOutline = GUI.Toggle(Rect(5, 40, 200, 40), HardwareOutline, "Racing outline", "button");
    ...
    if(HardwareOutline)
    {
        GUI.Window (0, Rect (5, 140, 1270, 550), OutlineContent, "001 - Racing outline");    
    }
