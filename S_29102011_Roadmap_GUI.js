//Dan Welsh 2011
//Danveria Roadmap gui script ver 0.01
...
function OnGUI ()
{
    ...
    //Current page)
    if(GUI.Button (Rect (135, 95, 175, 25), "Roadmap Considerations"))
    {
    ...
    HardwareOutline = GUI.Toggle(Rect(5, 40, 200, 40), HardwareOutline, "Roadmap outline", "button");
