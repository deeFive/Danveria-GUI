//Dan Welsh 2011
//Danveria Network Considerations gui script ver 0.01
...
{
    GUI.Label (Rect (10, 20, 1270, 550), "Content by lauren herbert");
...
function OnGUI ()
{
    ...
    //Current page)
    if(GUI.Button (Rect (135, 95, 175, 25), "Network Considerations"))
    {
