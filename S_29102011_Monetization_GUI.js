//Dan Welsh 2011
//Danveria Monertization gui script ver 0.01
...
function OnGUI ()
{
    ...
    GUI.Box (new Rect (0,0, Screen.width, (screenHeight / 5)), "Danveria Ver 0.02 - Monertization\nHere we will take a look at the process of creating revenue streams that are fair to all parties involved, based on the goods and services we provide. ");
    ...
    //Current page)
    if(GUI.Button (Rect (135, 95, 175, 25), "Monertization"))
    {
    ...
    HardwareOutline = GUI.Toggle(Rect(5, 40, 200, 40), HardwareOutline, "Monertization outline", "button");
    ...
    if(HardwareOutline)
    {
        GUI.Window (0, Rect (5, 140, 1270, 550), OutlineContent, "001 - Monertization outline");    
    }
