...
function OnGUI ()
{
    ...
    GUI.Box (new Rect ((Screen.width/1.075), (Screen.height/3), (Screen.width/15), (Screen.height/3)),"");
    ...
    HomeWindow = GUI.Toggle(Rect((Screen.width/99), (Screen.height/99), (Screen.width/17), (Screen.height/20)), HomeWindow, "Restart", "button");

    //Create button 05 - Controls
    OptionWindow = GUI.Toggle(Rect((Screen.width/1.344), (Screen.height/99), (Screen.width/4), (Screen.height/20)), OptionWindow, "Controls", "button");   
