//Dan Welsh 2011
//Danveria Software Considerations gui script ver 0.02
...
function OnGUI ()
{
    ...
    //Current page)
    if(GUI.Button (Rect (135, 95, 175, 25), "Software Considerations"))
    {
    ...
    HardwareOutline = GUI.Toggle(Rect(5, 40, 200, 40), HardwareOutline, "Software outline", "button");
