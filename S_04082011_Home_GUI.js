...
function OnGUI ()
{
    ...
    HomeWindow = GUI.Toggle(Rect((Screen.width/99), (Screen.height/99), (Screen.width/4), (Screen.height/20)), HomeWindow, "Home", "button");
    /*
    ...
    */
    ...
    GameWindow = GUI.Toggle(Rect((Screen.width/3.65), (Screen.height/99), (Screen.width/4), (Screen.height/20)), GameWindow, "Games", "button");
    ...
    */
    ...
    OptionWindow = GUI.Toggle(Rect((Screen.width/1.85), (Screen.height/99), (Screen.width/4), (Screen.height/20)), OptionWindow, "Options", "button");   
    /*
    //Create Menu Danveria label 
    GUI.Label(Rect((Screen.width/1.45), (Screen.height/55), (Screen.width/8), (Screen.height/40)), "Danveria V0.03");
    */ 
    GUI.EndGroup(); 
